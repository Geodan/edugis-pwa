...
class GroupedArray {
    ...
    removeItem(item) {
        ...
        if ((itemIndex > -1) && !this.item[groupIndex]._ga_group && this.items[itemIndex].visible) {
    ...
    _updateGroup(item, isOpen) {
        ...
        if ((groupIndex > -1) && this.items[groupIndex]._ga_group && this.items[groupIndex].visible) {
            // found
