...
(function() {
    ...
    const mapgl = typeof maplibregl === 'undefined' ? mapboxgl : maplibregl;
    var origSetStyle = mapgl.Map.prototype.setStyle;
    mapgl.Map.prototype.setStyle = function() {
    ...
    mapgl.Map.prototype.setLanguage = function(language, noAlt) {
    ...
    mapgl.Map.prototype.autodetectLanguage = function(opt_fallback) {
