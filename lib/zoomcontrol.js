...
export default class ZoomControl {
  onAdd(map) {
    ...
    this._container.className = map.libName === 'mapboxgl' ? 'mapboxgl-ctrl mapboxgl-ctrl-group mapboxgl-ctrl-zoom' : 'maplibregl-ctrl maplibregl-ctrl-group maplibregl-ctrl-zoom';
