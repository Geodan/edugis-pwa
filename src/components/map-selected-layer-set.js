...
class MapSelectedLayerSet extends LitElement {
  ...
  render() {
    ...
    return html`
    ${this.layerlist.map(layer=>html`<map-selected-layer .layer="${layer}" .bounds="${layer.metadata.bounds}" .zoom="${this.zoom}" .datagetter="${this.datagetter}"></map-selected-layer>`)}
    `;
  }
}
