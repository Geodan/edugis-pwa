describe('empty spec', () => {
  it('passes', () => {
    ...
    cy.get('#app-container')
      ...
      .click()
    //document.querySelector("#app-container > edugis-app").shadowRoot.querySelector("web-map").shadowRoot.querySelector("#panel-container > map-panel:nth-child(2) > map-data-catalog").shadowRoot.querySelector("map-layer-tree").shadowRoot.querySelector("div.wrapper > div > ul > li:nth-child(1)")
    cy.get('#app-container')
      .find('edugis-app')
      .shadow()
      .find('web-map')
      ...
      .click()
    //document.querySelector("#app-container > edugis-app").shadowRoot.querySelector("web-map").shadowRoot.querySelector("#panel-container > map-panel:nth-child(2) > map-data-catalog").shadowRoot.querySelector("map-layer-tree").shadowRoot.querySelector("div.wrapper > div > ul > li:nth-child(1) > ul > li:nth-child(6)")
    cy.wait(1000)
    cy.get('#app-container')
      .find('edugis-app')
      .shadow()
      ...
      .click()
    cy.wait(1000)
    //document.querySelector("#app-container > edugis-app").shadowRoot.querySelector("web-map").shadowRoot.querySelector("#panel-container > map-panel:nth-child(2) > map-data-catalog").shadowRoot.querySelector("map-layer-tree").shadowRoot.querySelector("div.wrapper > div > ul > li:nth-child(1) > ul > li:nth-child(6) > ul > li:nth-child(1)")
    cy.get('#app-container')
      .find('edugis-app')
      .shadow()
      .find('web-map')
